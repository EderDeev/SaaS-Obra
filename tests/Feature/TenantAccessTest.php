...
class TenantAccessTest extends TestCase
{
    ...
    public function test_tenant_admin_can_create_orcamento_composicao(): void
    {
        ...
        $this->actingAs($user)
            ...
            ->assertOk()
            ->assertDontSee('Composicao de teste');
    }
    ...
    public function test_tenant_admin_can_add_insumo_to_orcamento_composicao(): void
    {
        ...
        $this->assertSame('25.00', $composicao->preco_onerado);
        $this->assertSame('20.00', $composicao->preco_desonerado);
        ...
        $this->assertSame('30.00', $item->preco_onerado);
        $this->assertSame('24.00', $item->preco_desonerado);
        $this->assertSame('30.00', $composicao->preco_onerado);
        $this->assertSame('24.00', $composicao->preco_desonerado);
    }
    ...
    public function test_composicao_show_details_analytic_items_by_state(): void
    {
        ...
        $para = OrcamentoComposicao::create([
            ...
            'preco_onerado' => '141.57',
            'preco_desonerado' => '136.46',
        ]);
    ...
    public function test_platform_admin_can_import_global_orcamento_composicoes(): void
    {
        ...
        $csv = implode("\n", [
            ...
            'Acessibilidade;104658;PISO PODOTATIL DE ALERTA OU DIRECIONAL, DE CONCRETO;M2;PA;182,83;180,22;abr/26;;',
        ]);
        ...
        $this->assertDatabaseHas('orcamento_composicoes', [
            ...
            'uf' => 'PA',
            'modelo' => 'SINAPI',
            'preco_onerado' => '182.83',
            'preco_desonerado' => '180.22',
        ]);
        ...
        $this->actingAs($platformAdmin)
            ->post(route('tenant.orcamentos.insumos.import', $tenant), [
                ...
                'file' => UploadedFile::fake()->createWithContent('insumos.csv', implode("\n", [
                    ...
                    '99999;'.$windowsDescricao.';UN;PA;CR;1,00;1,00;abr/26',
                    '99998;'.$windowsDescricaoComNbsp.';UN;PA;CR;1,00;1,00;abr/26',
                ])),
            ])
            ->assertRedirect()
            ->assertSessionHasNoErrors();
    ...
    public function test_tenant_admin_can_import_composicao_analitico_by_codes(): void
    {
        ...
        $this->assertSame('0.00', $parent->preco_onerado);
        $this->assertSame('0.00', $parent->preco_desonerado);
    }
    ...
    public function test_platform_admin_can_import_global_insumos_with_portuguese_month_reference(): void
    {
        ...
        $csv = implode("\n", [
            ...
            ';;;;;;;;',
            'codigo_insumo;descricao;unidade;uf;origem_preco;preco_nao_desonerado;preco_desonerado;data',
            '45333;ABERTURA PARA ENCAIXE DE CUBA;UN;AC;CR;302,08;302,08;abr/26',
            '45333;ABERTURA PARA ENCAIXE DE CUBA;UN;AC;CR;305,10;305,10;mai/26',
            ';;;;;;;;',
            ';;;;;;;;',
        ]);
    ...
    public function test_platform_admin_can_import_global_insumos_with_classificacao_column(): void
    {
        ...
        $csv = implode("\n", [
            ...
            '45333;SERVI'.chr(128).'OS;ABERTURA PARA ENCAIXE DE CUBA;UN;AC;CR;302,08;302,08;abr/26',
        ]);
