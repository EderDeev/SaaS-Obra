...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('relatorio_nao_conformidade_evidencias', function (Blueprint $table) {
            ...
            $table->foreignId('relatorio_nao_conformidade_acao_corretiva_id')->constrained('relatorio_nao_conformidade_acoes_corretivas')->cascadeOnDelete();
        ...
        Schema::create('relatorio_nao_conformidade_evidencia_photos', function (Blueprint $table) {
            $table->id();
            $table->foreignId('tenant_id')->constrained()->cascadeOnDelete();
            $table->foreignId('relatorio_nao_conformidade_evidencia_id')->constrained('relatorio_nao_conformidade_evidencias')->cascadeOnDelete();
            $table->foreignId('user_id')->nullable()->constrained()->nullOnDelete();
            $table->string('path');
