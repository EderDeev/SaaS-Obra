...
<head>
    ...
    <title>Proposta de acao corretiva - RNC {{ $rnc->formatted_number }}</title>
</head>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;background:#ffffff;border:1px solid #e5e7eb;border-radius:14px;overflow:hidden;">
                    <tr>
                        <td style="background:#0b5fff;color:#ffffff;padding:22px 26px;">
                            ...
                            <h1 style="margin:10px 0 0;font-size:22px;line-height:1.3;">Proposta de acao corretiva enviada</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:26px;">
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin:0 0 20px;border-collapse:collapse;">
                                ...
                                <tr>
                                    <td style="padding:10px 0;border-bottom:1px solid #eef2f7;color:#667085;font-size:13px;">Arquivo</td>
                                    <td style="padding:10px 0;border-bottom:1px solid #eef2f7;text-align:right;font-size:13px;font-weight:700;">{{ $acaoCorretiva->attachment_original_name }}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style="padding:10px 0;color:#667085;font-size:13px;">Enviado em</td>
                                    <td style="padding:10px 0;text-align:right;font-size:13px;font-weight:700;">{{ $acaoCorretiva->submitted_at?->format('d/m/Y H:i') }}</td>
                                </tr>
                            </table>

                            <div style="margin:0 0 24px;padding:16px;border:1px solid #e5e7eb;border-radius:10px;background:#fbfbfd;">
                                <div style="margin:0 0 8px;color:#667085;font-size:12px;font-weight:700;letter-spacing:.06em;text-transform:uppercase;">Proposta de acao</div>
                                <p style="margin:0;font-size:14px;line-height:1.6;color:#111827;">{{ $descricao ?: 'Sem descricao informada.' }}</p>
                            </div>
