        ...
        <main className="flex min-h-screen items-center justify-center bg-[var(--bg)] px-4 py-10">
            ...
            <section className="sig-card w-full max-w-md p-6">
                ...
                <form onSubmit={submit} className="mt-5 grid gap-3">
                    ...
                    <Field label="Nova senha" error={form.errors.password}><input type="password" value={form.data.password} onChange={(e) => form.setData('password', e.target.value)} required /></Field>
                    ...
                    <button className="sig-btn sig-btn-primary" disabled={form.processing}>Redefinir senha</button>
                </form>
            </section>
        </main>
    );
